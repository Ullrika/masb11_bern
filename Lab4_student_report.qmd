...
# 1. Introduction - Regression Analysis in R {.unnumbered}
...
# 2. Correlation analysis of the relationship between length and age in codfish{.unnumbered}
...
# 3. Simple linear regression for the relationship between length and age of codfish{.unnumbered}
...
## 4. Assumption Checking {.unnumbered}
...
## 5. Predictions and confidence intervals {.unnumbered}
...
# 6. Regression Analysis of the Relationship between Concentration and Absorbance{.unnumbered}
...
# 5. Statistic analysis {.unnumbered}
